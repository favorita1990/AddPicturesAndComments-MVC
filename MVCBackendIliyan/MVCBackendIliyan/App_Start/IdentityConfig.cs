...
namespace MVCBackendIliyan
{
    ...
    public class ApplicationUserManager : UserManager<UserModel, int>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore(context.Get<MVCBackendDb>()));
            ...
            manager.RegisterTwoFactorProvider("Phone Code", new PhoneNumberTokenProvider<UserModel, int>
            {
                MessageFormat = "Your security code is {0}"
            });
            manager.RegisterTwoFactorProvider("Email Code", new EmailTokenProvider<UserModel, int>
            {
