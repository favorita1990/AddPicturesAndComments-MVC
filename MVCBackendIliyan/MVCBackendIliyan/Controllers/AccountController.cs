...
namespace MVCBackendIliyan.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Register(RegisterViewModel model, string genter)
        {
            ...
            string message = null;
            var RoleManager = new RoleManager<Identity2Role, int>(new RoleStore(new Context.MVCBackendDb()));
            if (ModelState.IsValid)
            {
                ...
                if (genter == "1")
                    message = string.Format("Welcome Mr. {0}!", model.FirstName);
                else
                    message = string.Format("Welcome Ms. {0}!", model.FirstName);
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        RoleManager.Create(new Identity2Role { Name = "User" });
                    }
